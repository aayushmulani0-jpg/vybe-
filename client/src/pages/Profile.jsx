...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-primary px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
        ...
        {/* Orders List */}
        <AnimatedSection direction="right" delay={0.1} className="md:col-span-3">
            ...
            <div className="space-y-6">
              {orders.map((order, idx) => (
                <motion.div
                  ...
                  className="glass-card overflow-hidden hover:border-accent/20 transition-colors">
                  <div className="p-4 border-b border-white/10 bg-neutral-950 flex flex-wrap justify-between items-center gap-4">
                    ...
                    <div>
                      ...
                      <span className={`text-xs px-2 py-1 rounded font-semibold ${order.status === 'Completed' || order.status === 'Delivered'
