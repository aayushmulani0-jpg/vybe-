        ...
        <tbody>
          <tr>
            ...
            <td style={{ verticalAlign: 'top', textAlign: 'right', width: '50%' }}>
              ...
              <div style={{ color: secondaryColor }}><strong style={{ color: primaryColor }}>Order ID:</strong> {order.id?.toUpperCase() || order._id?.slice(-8).toUpperCase() || 'N/A'}</div>
              ...
              <div style={{ color: secondaryColor }}><strong style={{ color: primaryColor }}>Status:</strong> {order.status || 'Pending'}</div>
            </td>
          </tr>
        </tbody>
      </table>
